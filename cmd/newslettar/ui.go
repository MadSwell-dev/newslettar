    ...
    <script>
        ...
        async function resetEmailStrings() {
            ...
            try {
                ...
                // Monthly strings
                document.getElementById('monthly-email-title').value = 'Your Monthly Newslettar';
                document.getElementById('monthly-week-range-prefix').value = 'Month of';
                document.getElementById('monthly-coming-this-week-heading').value = 'Coming This Month';
                document.getElementById('monthly-downloaded-section-heading').value = 'Downloaded Last Month';
                document.getElementById('monthly-no-shows-message').value = 'No shows scheduled for this month';
                document.getElementById('monthly-no-movies-message').value = 'No movies scheduled for this month';
                document.getElementById('monthly-no-downloaded-shows-message').value = 'No shows downloaded this month';
                document.getElementById('monthly-no-downloaded-movies-message').value = 'No movies downloaded this month';
                document.getElementById('monthly-anticipated-series-heading').value = 'Most Anticipated Series (Next Month)';
                document.getElementById('monthly-watched-series-heading').value = 'Most Watched Series (Last Month)';
                document.getElementById('monthly-anticipated-movies-heading').value = 'Most Anticipated Movies (Next Month)';
                document.getElementById('monthly-watched-movies-heading').value = 'Most Watched Movies (Last Month)';
